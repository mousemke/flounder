...
describe( 'defaultOptions', () =>
{
    ...
    it( 'should have the correct default prop', () =>
    {
        ...
        assert.equal( dVal.onClose, null );
        assert.equal( dVal.onComponentDidMount, null );
        assert.equal( dVal.onComponentWillUnmount, null );
        assert.equal( dVal.onFirstTouch, null );
        assert.equal( dVal.onInit, null );
        assert.equal( dVal.onInputChange, null );
        assert.equal( dVal.onOpen, null );
        assert.equal( dVal.onChange, null );
